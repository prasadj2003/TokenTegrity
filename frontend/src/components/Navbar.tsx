...
function Navbar() {
  ...
  return (
    <nav className="block w-full max-w-screen-2xl px-4 py-5 mx-auto text-white bg-slate-900 shadow-md rounded-md lg:px-8 lg:py-5 mt-10">
      <div className="container flex flex-wrap items-center justify-between mx-auto text-gray-100">
        <a
          href="/"
          className="mr-4 block cursor-pointer py-1.5 text-base text-gray-200 font-semibold font-mono"
        >
          TokenTegrity
        </a>
